# Description
This is an API to practice how to build application on Azure ☁, it is part of a lab 🧪 for az-204 certificate 📜 exam. This a backend for management the image 🏞️ storage process ⚙️. This api is built in C# and .net core framework
